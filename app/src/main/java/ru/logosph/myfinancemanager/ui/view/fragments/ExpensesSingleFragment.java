...
import ru.logosph.myfinancemanager.ui.viewmodels.ExpensesSingleViewModel;
...
public class ExpensesSingleFragment extends Fragment {
    ...
    ExpensesSingleViewModel viewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(ExpensesSingleViewModel.class);
        ...
        if (viewModel.getLoadingState().getValue() == ExpensesSingleViewModel.LoadingState.SUCCESS) {
            binding.progress.setVisibility(View.GONE);
            binding.blocking.setVisibility(View.GONE);
        } else {
